...
namespace Igloo
{
    ...
    public class PeHeaderReader
    {
        ...
        public static PeHeader Read(BinaryReader reader)
        {
            ...
            uint dirDirectoryCount = hdr.Is32BitHeader ? hdr.OptionalHeader32.NumberOfRvaAndSizes : hdr.OptionalHeader64.NumberOfRvaAndSizes;

            if (dirDirectoryCount > 0)
            {
                List<IMAGE_DATA_DIRECTORY> ddl = new List<IMAGE_DATA_DIRECTORY>((int)dirDirectoryCount);
