...
namespace Igloo
{
    ...
    public class SSTSrcModule : SubsectionData
    {
        ...
        public override void Read(BinaryReader r)
        {
            ...
            for (int i = 0; i < cFile; i++)
            {
                ...
                SourceFileInformation sfi = new SourceFileInformation();

                uint cSeg2 = r.ReadUInt16();
                uint pad = r.ReadUInt16(); // pad
                ...
                for (int j = 0; j < cSeg2; j++)
                {
                    ...
                    SourceSegmentInfo ssi = new SourceSegmentInfo();

                    ssi.SegmentId = r.ReadUInt16();
                    uint cPair = r.ReadUInt16();
    ...
    public class SSTLibraries : SubsectionData
    {
        ...
        public override void Read(BinaryReader reader)
        {
            ...
            long absEndOffset = reader.BaseStream.Position + Header.Size;
    ...
    public class SSTFileIndex : SubsectionData
    {
        ...
        public override void Read(BinaryReader r)
        {
            ...
            long remainingBytes = Header.Size - (r.BaseStream.Position - initPos);

            List<string> names = new List<string>();

            for (long i = remainingBytes; i != 0; )
            {
